...
from account.api.views.profile_views import ChildProfileUpdateAPIView, GetChildByIdentityAPIView, InstructorProfileUpdateAPIView, MeAPIView, ParentProfileUpdateAPIView
...
urlpatterns = [
    ...
    path("get-child-by-identity/<identity_number>", GetChildByIdentityAPIView.as_view(), name = "get_child_by_identity"),
